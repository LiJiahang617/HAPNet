...
convnext_pretrained = 'https://download.openmmlab.com/mmclassification/v0/convnext/downstream/convnext-small_3rdparty_32xb128-noema_in1k_20220301-303e75e3.pth' # noqa
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type='CheckpointHook', by_epoch=True, interval=500,
        save_best='mIoU'),
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="HeFFT_twin_sum_convnext-s_no_aux")),
]
visualizer = dict(

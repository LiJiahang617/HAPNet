...
augreg_pretrained = '/home/ljh/Desktop/TIV/TIV/pretrained/augreg_base_patch16_384_imagenet21k.pth'
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="augreg_adapter-b_ld_080_lr2e-4_epo100")),
]
visualizer = dict(

...
model = dict(
    ...
    backbone=dict(
        type='mmpretrain_custom.BEiTAdapter_remove_cpa',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="RTFormer-MFNet", name="HeFFT_remove_cpa_bsl_ld_090_lr1e-4")),
]
visualizer = dict(

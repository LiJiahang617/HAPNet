...
beitv1_pretrained = 'pretrained/beit_base_patch16_224_pt22k_ft22k.pth'
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="beitv1_adapter-b_ld_080_lr2e-4_epo100")),
]
visualizer = dict(

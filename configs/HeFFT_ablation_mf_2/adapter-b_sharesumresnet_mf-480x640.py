...
model = dict(
    ...
    backbone=dict(
        type='mmpretrain_custom.BEiTAdapter_sharesum_resnet',
        ...
        x_modality_encoder=dict(
            type='mmseg_custom.ShareSumResNet',
            depth=101,
            deep_stem=False,
            num_stages=4,
            out_indices=(0, 1, 2, 3),
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="HeFFT_share_sum_resnet_no_aux")),
]
visualizer = dict(

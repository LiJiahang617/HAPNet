...
swin_pretrained = 'https://download.openmmlab.com/mmsegmentation/v0.5/pretrain/swin/swin_small_patch4_window7_224_20220317-7ba6d6dd.pth'  # noqa
...
model = dict(
    ...
    backbone=dict(
        ...
        x_modality_encoder=dict(
            type='mmseg_custom.ShareSumSwinTransformer',
            embed_dims=96,
            depths=[2, 2, 18, 2],
            num_heads=[3, 6, 12, 24],
            window_size=7,
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="HeFFT_share_sum_swin-s_no_aux")),
]
visualizer = dict(

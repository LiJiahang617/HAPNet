...
default_hooks = dict(
    ...
    visualization=dict(type='MTLVisualizationHook', interval=100, draw=True))
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="RoadFormer_nyu-480x640", name="convnext-b_0-1_hha_norm")),
]
visualizer = dict(

...
data_preprocessor = dict(
    ...
    mean=[0.485, 0.456, 0.406, 0, 0, 0], # because inputs has 6 channels, for two modalities are stacked by channels
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="tiv-twinmit", name="0-1_twinmit-b0+allmlp_norm")),
]
visualizer = dict(

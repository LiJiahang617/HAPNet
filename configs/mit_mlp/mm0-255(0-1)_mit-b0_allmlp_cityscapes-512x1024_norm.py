...
# remember to modify related code in loading.py after this exp is done!
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="tiv-twinmit", name="0-255(0-1)_twinmit-b0+allmlp_norm")),
]
visualizer = dict(

...
data_root = '/remote-home/jhli/TIV/TIV/data/NYU_oridepth'
...
data_preprocessor = dict(
    ...
    mean=[123.675, 116.28, 103.53, 0, 0, 0], # because inputs has 6 channels, for two modalities are stacked by channels
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project="ECCV-NYUdepth", name="beit-adapter-b_share_sum_convnext-s_enhance_data_layer_decay_constructor_lr2e-5")),
]
visualizer = dict(

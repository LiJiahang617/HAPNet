...
model = dict(
    ...
    backbone=dict(
        type='mmpretrain_custom.BEiTAdapter_spmsum',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="ECCV-MFNet", name="beit-adapter-b_share_spm_constructor090_lr1e-4_200epo")),
]
visualizer = dict(

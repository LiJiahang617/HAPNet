...
# optimizer
optimizer = dict(
    type='AdamW', lr=0.00002, weight_decay=0.05, eps=1e-8, betas=(0.9, 0.999))
optim_wrapper = dict(
    type='OptimWrapper',
    optimizer=optimizer,
    constructor='LayerDecayOptimizerConstructor',
    paramwise_cfg=dict(vit_num_layers=24, decay_rate=0.9, x_encoder_num_layers=24),
...
vis_backends = [dict(type='LocalVisBackend'),
                dict(type='WandbVisBackend', init_kwargs=dict(project="ECCV-MFNet", name="beit-adapter-l_share_sum_convnext-s_layer_decay_constructor_lr2e-5")),
]
visualizer = dict(

...
model = dict(
    ...
    backbone=dict(
        type='mmpretrain_custom.BEiTAdapter_rgbt_conv_patch',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="adapter-b_convnext-s_rgbt_conv_patch_ld_090_lr1e-4")),
]
visualizer = dict(

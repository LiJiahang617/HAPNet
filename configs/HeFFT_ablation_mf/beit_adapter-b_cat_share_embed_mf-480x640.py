...
model = dict(
    ...
    backbone=dict(
        type='mmpretrain_custom.BEiTAdapter_concat_share_patch',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="adapter-b_convnext-s_cat_share_patch_no_aux")),
]
visualizer = dict(

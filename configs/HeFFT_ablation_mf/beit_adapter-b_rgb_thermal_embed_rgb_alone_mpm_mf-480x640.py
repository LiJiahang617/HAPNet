...
model = dict(
    ...
    backbone=dict(
        type='mmpretrain_custom.BEiTAdapter_patch_rgb_thermal_mpm_rgb_alone',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="HeFFT_ablation_MFNet", name="adapter-b_convnext-s_rgb_thermal_patch_rgb_mpm_no_aux")),
]
visualizer = dict(

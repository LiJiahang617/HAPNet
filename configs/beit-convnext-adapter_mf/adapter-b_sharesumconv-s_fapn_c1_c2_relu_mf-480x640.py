...
model = dict(
    ...
    backbone=dict(
        ...
        type='mmpretrain_custom.BEiTAdapter_rgbxsum_fapn_c1_c2_relu',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="RTFormer-MFNet", name="beit-b_share_sum_convnext-s_fapn_c1_c2_relu_ld_090_lr1e-4")),
]
visualizer = dict(

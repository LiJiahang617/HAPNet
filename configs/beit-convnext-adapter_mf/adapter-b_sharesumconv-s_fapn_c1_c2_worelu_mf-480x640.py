...
model = dict(
    ...
    backbone=dict(
        # fapn in c1 + c2 not in x1 x2
        type='mmpretrain_custom.BEiTAdapter_rgbxsum_fapn_c1_c2_worelu',
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="RTFormer-MFNet", name="beit-b_share_sum_convnext-s_fapn_c1_c2_worelu_ld_090_lr1e-4")),
]
visualizer = dict(

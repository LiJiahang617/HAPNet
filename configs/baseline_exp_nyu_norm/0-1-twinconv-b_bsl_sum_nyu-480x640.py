...
model = dict(
    ...
    decode_head=dict(
        ...
        in_channels=[128, 256, 512, 1024],  # modified here
        strides=[4, 8, 16, 32],
        feat_channels=256,
        out_channels=256,
...
vis_backends = [dict(type='LocalVisBackend'),
                # dict(type='WandbVisBackend', init_kwargs=dict(project="fusion-study_conv-b_nyu-480x640_norm", name="baseline_sum_0-1_hha")),
]
visualizer = dict(

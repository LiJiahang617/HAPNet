...
class BEiTAdapter_rgbt_conv_patch(BEiT):
    arch_settings = {
        'atto': {
            'depths': [2, 2, 6, 2],
    ...
    def __init__(self, pretrain_size=224, n_points=4, deform_num_heads=6,
        ...
        self.input_conv = nn.Conv2d(6, 3, kernel_size=1, stride=1, padding=0)
        self.input_norm = nn.LayerNorm([3, 480, 480])
        print('Note, this is ablation study for adapter-share_patch!!!')
    ...
    def forward(self, inputs):
        ...
        c1, c2, c3, c4 = self.x_modality_encoder(inputs)

...
class BEiTAdapter_concat_share_patch(BEiT_cat_share):
    arch_settings = {
        'atto': {
            'depths': [2, 2, 6, 2],
    ...
    def __init__(self, pretrain_size=224, n_points=4, deform_num_heads=6,
        ...
        print('Note, this is ablation study for adapter-concat_share_patch!!!')
    ...
    def forward(self, x):
        ...
        x, H, W = self.patch_embed(torch.cat((x,y), dim=1))

...
class TwinBeiTCat(DualBEiT):
    ...
    def __init__(self, pretrain_size=224, n_points=4, deform_num_heads=6,
        ...
        print('Note, this is ablation study for adapter-twin_vit-b_conat!!!')
        ...
        self.norm1 = nn.SyncBatchNorm(embed_dim*2)
        self.norm2 = nn.SyncBatchNorm(embed_dim*2)
        self.norm3 = nn.SyncBatchNorm(embed_dim*2)
        self.norm4 = nn.SyncBatchNorm(embed_dim*2)
    ...
    def forward(self, inputs):
        ...
        c1, c2, c3, c4 = torch.cat((x1, y1), dim=1), torch.cat((x2, y2), dim=1), torch.cat((x3, y3), dim=1), torch.cat((x4, y4), dim=1)

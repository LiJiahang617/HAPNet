...
class BEiTAdapter_rgbxcat(BEiT):
    arch_settings = {
        'atto': {
            'depths': [2, 2, 6, 2],
    ...
    def __init__(self, pretrain_size=224, n_points=4, deform_num_heads=6,
        ...
        self.fc1 = nn.Conv2d(self.x_channels[0]*2, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)
        self.fc2 = nn.Conv2d(self.x_channels[1]*2, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)
        self.fc3 = nn.Conv2d(self.x_channels[2]*2, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)
        self.fc4 = nn.Conv2d(self.x_channels[3]*2, embed_dim, kernel_size=1, stride=1, padding=0, bias=True)

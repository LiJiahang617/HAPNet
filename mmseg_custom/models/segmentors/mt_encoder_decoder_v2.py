...
class MTEncoderDecoderv2(BaseSegmentor):
    """Multi-task Encoder Decoder architecture v2 for semantic segmentation.

    Multi-task EncoderDecoder typically consists of backbone, neck, mult-task decode_heads and auxiliary_head(optional).

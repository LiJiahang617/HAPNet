...
from mmcv_custom.cnn import build_conv_layer, build_norm_layer, build_plugin_layer
...
class ShareSumResNet(BaseModule):
    """ResNet backbone.
...
@MODELS.register_module()
class ShareSumResNetV1c(ShareSumResNet):
...
@MODELS.register_module()
class ShareSumResNetV1d(ShareSumResNet):

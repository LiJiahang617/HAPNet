...
class MMKPDataset(BaseSegDataset):
    """MultiModal KP day-and-ngiht RGB-T Semantic Segmentation 5 categories dataset.
    ...
    METAINFO = dict(
        classes=('road', 'sidewalk', 'building', 'wall', 'fence', 'pole', 'traffic light', 'traffic sign', 'vegetation',
                 'terrain', 'sky', 'person', 'rider', 'car', 'truck', 'bus', 'train', 'motorcycle', 'bicycle', 'void'),
